...
import { ASSET_REGISTRY_TOTAL, REGISTRY_QUALITY_INSIGHTS, type RegistryQualityInsight } from "@/lib/asset-registry-data";

export function RegistryQualityInsights({ data = REGISTRY_QUALITY_INSIGHTS, total = ASSET_REGISTRY_TOTAL }: { data?: RegistryQualityInsight[]; total?: number }) {
  return (
    <Card>
      <CardHeader>
          ...
          <div className="relative h-48 min-w-0">
            ...
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <p className="text-xl font-black text-slate-950 dark:text-slate-100">{total.toLocaleString()}</p>
